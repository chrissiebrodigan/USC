...
<head>
    ...
    <!-- Framework CSS -->
    <link rel="stylesheet" href="jjomedia2.css" type="text/css" media="screen, projection, print" />
...
<!-- Yahoo! Inc.
var ysm_accountid  = "151OMTLLGS092AMMINV9EFPKQD0";
...
<div class="label">This will only take a minute.</div>

<div id="step1">
	<div class="status-wrap">
		<div class="status-bar"></div>
		<div class="status-percentage">10% Complete</div>
	</div>
	...
	<table cellspacing="0">
		<tr>
			<td colspan="4">
				<label id="description" for="description2" class="main">Which Best Describes You?</label> 
				<div id="descriptionField"> 
					<div><input type="radio" checked name="00N80000002UJr8" value="MAT with Teaching Credential" /><label>Aspiring teacher</label></div>
					<div><input type="radio" name="00N80000002UJr8" value="MAT" /><label>Current teacher</label></div>
...
<div id="step2" style="display:none">
	<div class="status-wrap">
		<div class="status-bar"></div>
		<div class="status-percentage">30% Complete</div>
	</div>
	...
	<table cellspacing="0">
		<tr>
			<td colspan="4">
				<div><label id="education" for="education2">Highest Level of Education</label> 
				...
				<label id="gpa" for="gpaRange">Undergraduate GPA Range</label> 
					<div id="gpaField"> 
						<select  id="gpaRange" name="00N80000004FxJD" title="Stated GPA Range" class="required"> 
							<option selected value="">Select One</option> 
	...
	<a class="next-2" href="#">Next Step</a>
</div>

<div id="step3" style="display:none">
	<div class="status-wrap">
		<div class="status-bar"></div>
		<div class="status-percentage"></div>
	</div>
...
<input type="hidden" id="00N8000000304f8" name="00N8000000304f8" title="Landing Page" value="<?php echo $l; ?>" />
	...
	<div id="submit"> 
		<input name="submitBtn" type="image" id="submitBtn" src="images/btn-submit.jpg" alt="Request Information" /> 
	</div> 
...
<div class="footer-wrap">
	...
	<div><strong>MAT@USC Admissions:</strong> 1-888-MAT-1USC (888-628-1872)  |  &copy;2009-2010 USC Rossier School of Education. All rights reserved.  |  <strong>MAT@USC:</strong> <a href="http://mat.usc.edu" title="Master of Arts in Teaching Delivered Online">Master of Arts in Teaching Delivered Online</a></div>
...
<!-- include jQuery library -->
	...
	$(document).ready(function(){
		...
		$('#step1 .next').click(function() {
		  $('#step1').toggle('slow', function() {
		  	$('#step2').toggle('fast');
		  });
		});
		
		$('#step2 .next-2').click(function() {
		  
		  	var eduValue = $("#education2").val();
		  	var gpaVal = $("#gpaRange").val();
