<?php
$splash_creative = (isset($splash_creative)) ? $splash_creative : 'main';
?>
		...
		<div id="content">
			...
			<div id="questionnaire">
				...
				<div id="questionnaire-content">
					...
					<img class="privacy" src="images/privacy.gif" alt="Your privacy is important to us" width="29" height="32" />
				</div>
